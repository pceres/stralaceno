...
$id = sanitize_user_input($_REQUEST['id'], 'number', ['number_type'=>'int']);
...
l'indirizzo e-mail: 
<a href="mailto:<?php echo $email_info?>?subject=Info%20sui%20partecipanti%20alla%20<?php echo rawurlencode($race_name) ?>"><?php echo $email_info?></a>, oppure agire direttamente iscrivendosi al sito <a href="<?php echo $link_geneal?>">Genealogia di Caposele</a>.  <br>
</div>
