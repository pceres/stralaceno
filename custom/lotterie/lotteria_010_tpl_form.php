...
// 		else if (i < 15)
	...
	gironeH = new Array("Colombia","Giappone","Polonia","Senegal");
...
<TABLE FRAME=VOID CELLSPACING=0 RULES=GROUPS BORDER=1 SUMMARY=left_column_table>
	...
	<TBODY>
		<TR>
			<TD COLSPAN=4 WIDTH=801 HEIGHT=23 ALIGN=CENTER><FONT SIZE=4>Mondiali 2018 - Scheda per il sondaggio -</FONT></TD>
			</TR>
<?php
if (!empty($nominativo)) { ?>
		<TR>
...
<input name='question_35' type='hidden' value='0'>
		...
		<TR>
			...
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Senegal</TD>
		</TR>
		<TR>
			<TD HEIGHT=18 ALIGN=LEFT BGCOLOR="#E6E6FF">Serbia</TD>
...
<!-- 	<COLGROUP><COL WIDTH=80><COL WIDTH=95><COL WIDTH=110></COLGROUP> -->
	<TBODY>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#CCFFFF"><B>Gironi eliminatori (14 - 28 giugno 2018)</B></TD>
		</TR>
		<TR>
			<TD COLSPAN=3 ALIGN=LEFT BGCOLOR="#CCFFFF">La prima fase si articolera' in 48 partite (6 per ciascun girone) in 15 giorni:</TD>
		</TR>
		<TR>
			<TD COLSPAN=3 ALIGN=LEFT BGCOLOR="#CCFFFF">si giochera' dalle ore 13.00 alle 21.00 (orari variabili a seconda dei fusi)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT><BR></TD>
			<TD ALIGN=LEFT><BR></TD>
