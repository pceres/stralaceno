...
// alert('2: '+list.length);
	...
	gironeA = new Array("Polonia","Grecia","Russia","Repubblica Ceca");
	gironeB = new Array("Olanda","Danimarca","Germania","Portogallo");
	gironeC = new Array("Spagna","Italia","Irlanda","Croazia");
	gironeD = new Array("Ucraina","Svezia","Francia","Inghilterra");
/*	gironeE = new Array();
	gironeF = new Array();
	gironeG = new Array();
	gironeH = new Array();*/
...
// alert('3: '+auth_provenienza.toUpperCase(auth_provenienza));
	...
	if (!<?php echo $admin_mode; ?>)
	{
		...
		{
		case 'CAPOSELE$$$$$$$$$$$$$$': // per ripristinare il check togliere i $
/*		case 'MATERDOMINI':
		case 'PORTELLA':
		case 'BUONINVENTRE':
		case 'PASANO':*/
...
<TABLE FRAME=VOID CELLSPACING=0 RULES=GROUPS BORDER=1>
	...
	<TBODY>
		<TR>
			<TD COLSPAN=4 WIDTH=801 HEIGHT=23 ALIGN=CENTER><FONT SIZE=4>Europei 2012 - Scheda per il sondaggio -</FONT></TD>
			</TR>
<?php
if (!empty($nominativo)) { ?>
		<TR>
...
<!-- 	<COLGROUP><COL WIDTH=80><COL WIDTH=95><COL WIDTH=110></COLGROUP> -->
	<TBODY>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#CCFFFF"><B>Gironi eliminatori (8 - 19 giugno 2012)</B></TD>
		</TR>
		<TR>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#CCFFCC"><B>Quarti di Finale (21 - 24 giugno 2012)</B></TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">21/06 h. 20:45</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Varsavia</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">A1-B2 (S1)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">22/06 h. 20:45</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Danzica</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">B1-A2 (S2)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">23/06 h. 20:45</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Donetsk</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">C1-D2 (S3)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">24/06 h. 20:45</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Kiev</TD>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#FFFF99"><B>Semifinali (27 - 28 giugno 2012)</B></TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFFF99">27/06 h. 20:45</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFFF99">Donetsk</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFFF99">S1-S3 (F1)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFFF99">28/06 h. 20:45</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFFF99">Varsavia</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFFF99">S2-S4 (F2)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT><BR></TD>
			<TD ALIGN=LEFT><BR></TD>
		...
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#C0C0C0">01/07 h. 20:45</TD>
			<TD ALIGN=CENTER BGCOLOR="#C0C0C0">Kiev</TD>
