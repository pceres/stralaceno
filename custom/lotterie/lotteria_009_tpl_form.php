...
<meta name="keywords" content="lotteria, questionario, Europei 2016, sondaggio, classifica">
...
$archivio_domande = Array(
	Array(1,"Per chi si reca in gita alla Mauta Ã¨ consigliabile:",
	...
	Array(4,"Qual'Ã¨ il Santo patrono di Caposele?"      ,
	...
	Array(7,"Quale dei seguenti non Ã¨ un quartiere di Caposele?"          ,
			Array("Portella","Pianello","Campo Piano","Castello","Sanita'")					,"00100"),

	Array(8,"In che mese si festeggia la Madonna della SanitÃ ?" ,
	...
	Array(10,"Dove vennero ubicate le scuole elementari e medie di Caposele dopo il terremoto del 1980?"  ,
			Array("ai Piani","a li fuossi","alla SanitÃ ","al ponte") 					, "0010"),
...
// 		else if (i < 15)
	...
	gironeA = new Array("Brasile","Croazia","Messico","Camerun");
	gironeB = new Array("Spagna","Olanda","Cile","Australia");
	gironeC = new Array("Colombia","Grecia","Costa D'Avorio","Giappone");
	gironeD = new Array("Uruguay","Costa Rica","Inghilterra","Italia");
	gironeE = new Array("Svizzera","Ecuador","Francia","Honduras");
	gironeF = new Array("Argentina","Bosnia-Herzegovina","Iran","Nigeria");
	gironeG = new Array("Germania","Portogallo","Ghana","USA");
	gironeH = new Array("Belgio","Algeria","Russia","Corea Del Sud");
...
<TABLE FRAME=VOID CELLSPACING=0 RULES=GROUPS BORDER=1 SUMMARY=left_column_table>
	...
	<TBODY>
		<TR>
			<TD COLSPAN=4 WIDTH=801 HEIGHT=23 ALIGN=CENTER><FONT SIZE=4>Europei 2016 - Scheda per il sondaggio -</FONT></TD>
			</TR>
<?php
if (!empty($nominativo)) { ?>
		<TR>
...
<input name='question_35' type='hidden' value='0'>
		...
		<TR>
			<TD COLSPAN=3 HEIGHT=16 ALIGN=LEFT>La composizione dei sei gironi eliminatori:</TD>
		</TR>
		<TR>
		...
		<TR>
			<TD HEIGHT=18 ALIGN=LEFT BGCOLOR="#E6E6FF">Romania</TD>
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Russia</TD>
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Ucraina</TD>
		</TR>
		<TR>
			<TD HEIGHT=18 ALIGN=LEFT BGCOLOR="#E6E6FF">Albania</TD>
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Galles</TD>
		...
		<TR>
			...
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Irlanda del Nord</TD>
		</TR>
		...
		<TR>
			<TD HEIGHT=18 ALIGN=LEFT BGCOLOR="#FFFF99"><FONT FACE="Arial Narrow">Gruppo D</FONT></TD>
			<TD ALIGN=LEFT BGCOLOR="#FFFF99"><FONT FACE="Arial Narrow">Gruppo E</FONT></TD>
		...
		<TR>
			...
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Islanda</TD>
		</TR>
		<TR>
			<TD HEIGHT=18 ALIGN=LEFT BGCOLOR="#E6E6FF">Turchia</TD>
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Repubblica d'Irlanda</TD>
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Austria</TD>
		</TR>
		<TR>
			<TD HEIGHT=18 ALIGN=LEFT BGCOLOR="#E6E6FF">Croazia</TD>
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Svezia </TD>
			<TD ALIGN=LEFT BGCOLOR="#E6E6FF">Ungheria</TD>
		</TR>
...
<option>Repubblica d'Irlanda</option>
...
<!-- 	<COLGROUP><COL WIDTH=80><COL WIDTH=95><COL WIDTH=110></COLGROUP> -->
	<TBODY>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#CCFFFF"><B>Gironi eliminatori (10 - 22 giugno 2016)</B></TD>
		</TR>
		<TR>
			<TD COLSPAN=3 ALIGN=LEFT BGCOLOR="#CCFFFF">La prima fase si articolera' in 36 partite (6 per ciascun girone) in 13 giorni:</TD>
		</TR>
		<TR>
			<TD COLSPAN=3 ALIGN=LEFT BGCOLOR="#CCFFFF">si giochera' alle ore 15.00, 18.00, 21.00 (orari variabili a seconda dei fusi)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT><BR></TD>
			<TD ALIGN=LEFT><BR></TD>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#FFDDDD"><B>Ottavi di Finale (25 - 27 giugno 2016)</B></TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">25/06 h. 15:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Saint-Étienne</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">A2-C2 (Q1)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">25/06 h. 18:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Parigi</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">B1-A3/C3/D3 (Q2)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">25/06 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Lens</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">D1-B3/E3/F3 (Q3)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">26/06 h. 15:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Décines-Charpieu</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">A1-C3/D3/E3 (Q4)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">26/06 h. 18:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Villeneuve-d'Ascq</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">C1-A3/B3/F3 (Q5)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">26/06 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Tolosa</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">F1-E2 (Q6)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">27/06 h. 18:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Saint-Denis</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">E1-D2 (Q7)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFDDDD">27/06 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">Nizza</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFDDDD">B2-F2 (Q8)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT><BR></TD>
			<TD ALIGN=LEFT><BR></TD>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#CCFFCC"><B>Quarti di Finale (30 giugno - 3 luglio 2016)</B></TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">30/06 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Marsiglia</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Q1-Q3 (S1)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">01/07 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Villeneuve-d'Ascq</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Q2-Q6 (S2)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">02/07 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Bordeaux</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Q5-Q7 (S3)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#CCFFCC">03/07 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Saint-Denis</TD>
			<TD ALIGN=CENTER BGCOLOR="#CCFFCC">Q4-Q8 (S4)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT><BR></TD>
			<TD ALIGN=LEFT><BR></TD>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#FFFF99"><B>Semifinali (6 - 7 luglio 2016)</B></TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFFF99">06/07 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFFF99">Décines-Charpieu</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFFF99">S1-S2 (F1)</TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#FFFF99">07/07 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#FFFF99">Marsiglia</TD>
		...
		<TR>
			<TD COLSPAN=3 ALIGN=CENTER BGCOLOR="#C0C0C0"><B>Finale 1&deg;-2&deg;posto(10 luglio)</B></TD>
		</TR>
		<TR>
			<TD ALIGN=LEFT BGCOLOR="#C0C0C0">10/07 h. 21:00</TD>
			<TD ALIGN=CENTER BGCOLOR="#C0C0C0">Saint-Denis</TD>
