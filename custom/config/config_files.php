...
# nel formato:
# 	nomefile::cartella::descrizione_file::allowed_groups::md5_password::link::logdir
#
...
# root_admin
config_files.php::%config_dir%::configurazione generale::root_admin::eef358de0c01694206eafe104006f44b::index.php::%config_dir%
modules_config.php::%config_dir%::moduli custom presenti nel sito::root_admin::eef358de0c01694206eafe104006f44b::index.php::%config_dir%
users.php::%config_dir%::account al sito::root_admin::eef358de0c01694206eafe104006f44b::index.php::%config_dir%
...
soci_cfg.txt::%modules_dir%soci/::elenco soci e news ARS::admin::d36923926ed59333afab0bba1a4ad5e5::custom/moduli/soci/soci.php::%modules_dir%
