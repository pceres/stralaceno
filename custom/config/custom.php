...
$web_title = "Nusco 10 km Web";


# campo meta-description
$web_description = "Sito ufficiale della 10 km Nusco";


# campo meta-keywords (per i motori di ricerca)
$web_keywords = "10 km Nusco, Nusco, Maratonina, Corsa podistica, Atletica";
...
$nome_file_tempi = "tempi.csv";
$nome_file_atleti = "atleti.csv";
$nome_file_organizzatori = "organizzatori.csv";
