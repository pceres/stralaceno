...
<?php
$sezione     = sanitize_user_input($_REQUEST['page'],'plain_text',Array());		// determina la sezione
$module_data = sanitize_user_input($_REQUEST['module_data'],'plain_text',Array());	// personalizzazione file di cfg.
...
show_template($module_abs_path,$module_name.".tpl",$sezione,$module_data);
